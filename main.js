...
class WebSocketClient {
  ...
  log(msg, type = "info") {
    switch (type) {
      case "success":
        console.log(`[*][@itsmesatyavir - ACCOUNT ${this.accountIndex + 1}]${this.proxyIp ? `[${this.proxyIp}]` : ""} | ${msg}`.green);
        break;
      case "custom":
        console.log(`[*][@itsmesatyavir - Account ${this.accountIndex + 1}]${this.proxyIp ? `[${this.proxyIp}]` : ""} | ${msg}`.magenta);
        break;
      case "error":
        console.log(`[!] ${msg}`.red);
        break;
      case "warning":
        console.log(`[*][@itsmesatyavir - Account ${this.accountIndex + 1}]${this.proxyIp != "Local" ? `[${this.proxyIp}]` : ""} | ${msg}`.yellow);
        break;
      default:
        console.log(`[*][@itsmesatyavir - Account ${this.accountIndex + 1}]${this.proxyIp != "Local" ? `[${this.proxyIp}]` : ""} | ${msg}`.blue);
    }
  }
